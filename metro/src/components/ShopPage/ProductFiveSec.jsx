...
import ProductFive from "../../assets/ShopPagePic/img_9-360x432.jpg"
import SearchIcon from '@mui/icons-material/Search';
import FavoriteBorderIcon from '@mui/icons-material/FavoriteBorder';

const ProductFiveSec = () => {
  return (
   <>
        <div className='productFiveHover'>
            <div>
              <p className='pl-2 pr-2 rounded bg-black text-white absolute z-[1000] mt-5 ml-6 font-sans'>-11%</p>
            </div>
            <div className='overflow-hidden'>           
              <img src={ProductFive} alt="" className=' w-[308px] rounded transition ease-in-out delay-150 hover:-translate-y-16 hover:scale-105 duration-500...'/>
            </div>
            <div className='latterFive'>
            <p className=' text-slate-400 mt-3'>Ayurvedic Hair Oil</p>
            <div className='flex flex-wrap space-x-3 '>
              <p className=' text-slate-400 font-sans'><del>$999.00</del></p>
              <h2 className='text-xl font-semibold font-sans'>$888.00</h2>
            </div> 
            </div>          
            <div className='space-x-1 mt-3 bottomButtonFive'>
