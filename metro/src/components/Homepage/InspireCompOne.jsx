...
import InpireImageOne from "../../assets/./HomePagePic/blog-10-2-465x290.jpg"

const InspireCompOne = () => {
  return (
    <>
     <div>
              <div className='box-border overflow-hidden InpireImageOneImg'>
                ...
                <div className='InpireImageOneCircle w-[70px] h-[70px] rounded-full bg-white absolute -mt-24 ml-7'>
                  <div className=' mt-4 '>
